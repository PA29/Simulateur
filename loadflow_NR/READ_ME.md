Le package loadflow_NR comporte les modules utiles pour effectuer un calcul de load flow par la méthode de Newton-Raphson sur un réseau électrique basse tension.
Ces modules sont :
